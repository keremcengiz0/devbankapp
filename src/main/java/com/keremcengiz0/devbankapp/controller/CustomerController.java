...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CustomerDto> getCustomerDtoById(@PathVariable(name = "id") Long id) {
        return new ResponseEntity<>(customerService.getCustomerDtoById(id), HttpStatus.OK);
    }
